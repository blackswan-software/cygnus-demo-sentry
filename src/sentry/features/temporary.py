...
def register_temporary_features(manager: FeatureManager) -> None:
    ...
    # Move model creation and signal recording from segments consumer to SNUBA_ITEMS consumer
    manager.add("organizations:trace-items-consumer-model-creation", OrganizationFeature, FeatureHandlerStrategy.FLAGPOLE, api_expose=False)
