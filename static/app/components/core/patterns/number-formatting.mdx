...
1. **Type and Unit**. Sentry supports several known data types and their units. The data type heavily influences the formatting. e.g., the number `1543` could become `"25min"` or `"1.5MiB"` depending on the type and unit.
